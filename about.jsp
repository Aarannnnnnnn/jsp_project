			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						...
						<h2>นิดะห๊ นิติมูง</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010045</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/nidah.niteemung" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @nidah </a></p>
					</div>
					<div class="col-lg-4 pb-4">
						...
						<h2>อารัน มาหนิ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010032</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/ran.wanwan.5" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @muhammah</a></p>
					</div>
					<div class="col-lg-4 pb-4">
